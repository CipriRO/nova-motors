    ...
    <section className="px-5 lg:px-20">
      ...
      <div className="grid grid-cols-[repeat(4,_minmax(50px,_1750px))] justify-center gap-2 p-2 md:grid-cols-[repeat(6,_minmax(100px,_175px))] lg:gap-4">
        {FeaturedCars.map((car, index) => (
          <div
            className={`shaodw-md col-span-2 flex cursor-pointer flex-col items-center justify-center gap-3 rounded-xl bg-gray-300 p-3 transition-transform hover:scale-105 ${
